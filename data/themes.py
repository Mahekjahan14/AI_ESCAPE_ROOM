...
# Pexels photo IDs — all themes (reliable CDN)
_PEXELS = {
    "space_cover": 2156881,
    "space_r1": 3492831,
    "space_r2": 2833037,
...
def _img(key: str) -> str:
    """Thematic image — local file if present, else Pexels CDN."""
...
def resolve_image(key: str) -> str:
    """Resolve image at display time (picks up downloaded local files)."""
    return _img(key)
...
THEMES = {
    ...
    "haunted_mansion": {
        ...
        "cover_key": "haunted_cover",
        "rooms": [
            {
                "name": "Creaking Foyer",
                "image_key": "haunted_r1",
                "description": (
